...
url_button1 = InlineKeyboardButton(text="Информация о Python",
                                   url="https://surik00.gitbooks.io/aiogram-lessons/content/chapter5.html")
url_button2 = InlineKeyboardButton(text="Список полезной литературы",
                                   url="https://surik00.gitbooks.io/aiogram-lessons/content/chapter5.html")
